...
function ChannelInfo({ channel, onClose, currentUser, socket, onViewStats, friends = [], onlineUsers = [] }) {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            try {
                const res = await fetch(`https://localhost:3001/channels/${channel.id}`);
        ...
        const fetchStats = async () => {
            try {
                const res = await fetch(`https://localhost:3001/channels/${channel.id}/stats?userId=${encodeURIComponent(currentUser.id)}`);
                const data = await res.json();
    ...
    const handleFollow = async () => {
        ...
        try {
            if (displayChannel.visibility === 'Private' && displayChannel.settings?.requireApproval) {
                // Request to join
                await fetch(`https://localhost:3001/channels/${displayChannel.id}/join-request`, {
                    method: 'POST',
                ...
                // Follow directly
                await fetch(`https://localhost:3001/channels/${displayChannel.id}/follow`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
    ...
    const handleUnfollow = async () => {
        ...
        try {
            await fetch(`https://localhost:3001/channels/${displayChannel.id}/unfollow`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ userId: currentUser.id })
            });
    ...
    const handleDelete = async () => {
        if (window.confirm(`Are you sure you want to delete "${displayChannel.name}"? This action cannot be undone.`)) {
            try {
                await fetch(`https://localhost:3001/channels/${displayChannel.id}`, {
                    method: 'DELETE'
                });
                onClose();
            } catch (err) {
    ...
    const toggleSetting = async (setting, currentValue) => {
        try {
            ...
            await fetch(`https://localhost:3001/channels/${displayChannel.id}/settings`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                                                                    ...
                                                                    onClick={async (e) => {
                                                                        ...
                                                                        if (window.confirm(`Remove ${f.displayName} from followers?`)) {
                                                                            try {
                                                                                ...
                                                                                const res = await fetch(`https://localhost:3001/channels/${displayChannel.id}`);
                                                                                const data = await res.json();
                                                                                setFullChannel(data);
                                                                            } catch (e) { }
                                                                        }
                                                                ...
                                                                <button
                                                                    ...
                                                                    onClick={async (e) => {
                                                                        ...
                                                                        if (window.confirm(`Block ${f.displayName} from this channel?`)) {
                                                                            try {
                                                                                await fetch(`https://localhost:3001/channels/${displayChannel.id}/block`, {
                                                                                    method: 'POST',
                                                                                    headers: { 'Content-Type': 'application/json' },
                                                            ...
                                                            <div key={`${bid}-${idx}`} className="member-item">
                                                                ...
                                                                <div className="icon-actions">
                                                                    <button className="icon-circle" onClick={async (e) => {
                                                                        e.stopPropagation();
                                                                        try {
                                                                            await fetch(`https://localhost:3001/channels/${displayChannel.id}/unblock`, {
                                                                                method: 'POST',
                                                                                headers: { 'Content-Type': 'application/json' },
